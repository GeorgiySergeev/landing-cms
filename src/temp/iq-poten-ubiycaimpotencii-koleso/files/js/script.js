...
function Datee() {
    var msInDay = 86400000,
        counterLength = 33,
        months, countryName = 'ar', // Встановлюємо мову для місяців. 
        isAbbreviated = false, // Якщо потрібно скорочений варіант місяців з трьох букв, наприклад "янв", "июн" і т.д, тоді ставим TRUE.
        localDate = new Date();

    switch (countryName) {
             case 'ar': // 
            months = ['كَانُونُ الثَّانِي', 'شُبَاطُ ', 'أزَارُ ', 'نِيسَانُ ', 'أيَّارُ ', 'حَزِيرَانُ ', 'يوليو ', 'آبُ ', 'أيْلُولُ ', 'تِشْرِينَ الأَوَّلُ ', 'تِشْرِينَ الثَّانِي', 'كَانُونُ الأَوَّلُ '];
            break;
        case 'es': // Spain
